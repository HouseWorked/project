...
(function($) {
  return $.fn.dependentSelects = function(options) {
    ...
    createNewSelect = function(name, $select, depth) {
      ...
      $newSelect = $('<select class="dependent-sub form-control"/>').attr('data-dependent-depth', depth).attr('data-dependent-input-name', $select.attr('data-dependent-input-name')).attr('data-dependent-id', select_id).addClass(options["class"]).append(placeholderOptionAtDepth(depth));
